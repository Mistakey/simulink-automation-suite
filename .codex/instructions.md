...
- Releasing or version bumps → also read `.claude/rules/release.md`, `.github/workflows/release.yml`, `scripts/check_release_metadata.py`, and `scripts/build_release_notes.py`
