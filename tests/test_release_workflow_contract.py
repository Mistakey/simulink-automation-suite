...
RELEASE_RULE_PATH = REPO_ROOT / ".claude" / "rules" / "release.md"
...
class ReleaseWorkflowContractTests(unittest.TestCase):
    ...
    def test_release_docs_explain_tag_driven_automation(self):
        ...
        self.assertIn("release.md", claude_text)
        ...
        self.assertIn("tag-driven", release_rule_text.lower())
        self.assertIn("workflow_dispatch", release_rule_text)
        self.assertIn("build_release_notes.py", release_rule_text)
        self.assertIn("docs/release", release_rule_text)
        self.assertIn("fallback", release_rule_text.lower())
        self.assertIn("Detailed release policy belongs in this rule file", release_rule_text)
        self.assertIn("CLAUDE.md", release_rule_text)
